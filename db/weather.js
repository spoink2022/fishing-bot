...
async function insertEntries(entryArr) {
    let query = `INSERT INTO weather (start_time, end_time, date_string, l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12) VALUES ${entryArr.map(o => `(${Object.values(o).join(', ').replace(/"/g, "'")})`).join(', ')}`;
