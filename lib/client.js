...
const { hasCustomFish, getCustomFish } = require('./global/custom_fish.js');
...
async function onReady() {
    client.user.setActivity('Major Update!\n/updates to see what\'s new!\n/quickstart to start playing!', { type: 'PLAYING' });
