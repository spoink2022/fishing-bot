...
async function hasValidPrefix(str) {
    return ACCEPTED_PREFIXES_1.includes(str[0]) || ACCEPTED_PREFIXES_2.includes(str.substring(0, 2));
}
async function onMessage(msg) {
    ...
    if (msg.channel.type === 'dm' || await hasValidPrefix(msg.content)) {
        ...
        let options = {
            ...
            \n\nReady to start? Just type \`${msg.prefix}start\`\
