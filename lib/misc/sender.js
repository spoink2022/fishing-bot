...
module.exports.sendVoteMessage = async function(userid, voteBonus) {
    let message = 'Thanks for voting! Your fishing cooldown has been reset. Go fish!';
    if (voteBonus) { message += `\n+${voteBonus} :lollipop:`; }
