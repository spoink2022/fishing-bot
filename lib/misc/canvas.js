...
module.exports.createCanvasForEquipment = async function(rodID, lineID, hookID, gloveID, equippedRing, premiumRing, swivelID) {
    ...
    if (equippedRing) {
        ...
        ctx.drawImage(ringImg,
            ...
            W/2-S/2+S/24, S/36 + (premiumRing ? 0 : S/24), // place at (dx, dy) on the canvas while accounting for padding
