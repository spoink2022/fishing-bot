...
const commands = [
	...
	new SlashCommandBuilder().setName('opt').setDescription('Change the availability of your game information.')
	.addSubcommand(subcommand => subcommand.setName('in').setDescription('Allow other players to view your stats.'))
	.addSubcommand(subcommand => subcommand.setName('out').setDescription('Prevent other players from viewing your stats.')),
	...
	new SlashCommandBuilder().setName('rankings').setDescription('See how your fish collection fares against the world!'),
...
if (!PROD) {
	...
	const guildId3 = '929071597262893137'; // Big Tuna Testing Grounds
