...
const commands = [
	...
	.addSubcommandGroup(group => group.setName('ring').setDescription('Buy a ring.')
		.addSubcommand(subcommand => subcommand.setName('regular').setDescription('Buy a regular ring.'))
		.addSubcommand(subcommand => subcommand.setName('premium').setDescription('Buy a premium ring.'))
	),
	...
	new SlashCommandBuilder().setName('ring').setDescription('Check your rings.')
	.addIntegerOption(
		option => option.setName('id').setDescription('Check a specific ring.').setRequired(false)
	)
	.addUserOption(
