...
async function sendTest() {
    console.log(api.fishing.getFishData(5));
    console.log(api.fishing.getFishData(16));
    console.log(capitalizeWords('Grass Pickerel'));
    console.log(capitalizeWords('Freshwater Drum'));
}