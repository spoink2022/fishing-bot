...
module.exports.sendAquariumCommand = async function(interaction, user, author, locationId, mentionedUser) {
    // AQUARIUM
...
module.exports.sendAquariumsCommand = async function(interaction, user, author, mentionedUser) {
    // AQUARIUMS
    // Step 1 - Validate mentionedUser Argument
    if (mentionedUser && mentionedUser.id !== user.userid) {
        if (mentionedUser.bot) {
...
module.exports.sendCollectCommand = async function(interaction, user, author) {
    // COLLECT
