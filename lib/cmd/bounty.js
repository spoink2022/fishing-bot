...
module.exports.sendBountyCommand = async function(interaction, user, author) {
    // BOUNTY
    // Step 1 - Validate User Level
    if (user.level < 10) {
        return interaction.reply('You must reach **Lvl. 10** before accessing the weekly bounty!');
    }
