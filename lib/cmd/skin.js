...
module.exports.sendSkinCommand = async function(interaction, user, skinId) {
    // SKIN
    // Step 1 - Validate ID
    if (!skinId) { return interaction.reply('You must specify the id of the skin to view!'); } // text-based command calls
    ...
    interaction.reply({ embeds: [embed], files: [attachment], components: [row] }).then(async (sentMessage) => {
