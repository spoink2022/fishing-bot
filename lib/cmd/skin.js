...
const INDEX_TO_LETTER = ['A'];
const CATEGORY_ARR = ['equipment_banner'];

module.exports.sendSkinCommand = async function(interaction, user) {
    // SKIN
    // Step 1 - Validate ID
    ...
    interaction.reply({ embeds: [embed], files: [attachment], components: [row] }).then(async () => {
