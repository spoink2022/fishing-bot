...
module.exports.sendQuestCommand = async function(interaction, user, mentionedUser) {
    ...
    switch (user.quest_type) {
        ...
        case 4:
            ...
            embedTitle = `Bait Quest - Catch fish using ${logic.text.capitalizeWords(baitName.replace(/_/g, ' '))} ${user.quest_requirement} times`;
            progressString = `${user.quest_progress}/${user.quest_requirement}`;
            break;
        default:
            break;
...
async function handleClaimButton(user, author, clan) {
    ...
    switch (newQuest.quest_type) {
        ...
        case 4:
            ...
            embedTitle = `Bait Quest - Catch fish using ${logic.text.capitalizeWords(baitName.replace(/_/g, ' '))} ${newQuest.quest_requirement} times`;
            progressString = `0/${newQuest.quest_requirement}`;
            break;
        default:
            break;
