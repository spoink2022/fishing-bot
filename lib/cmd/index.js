...
const cmdObjects = [Game, Extras, Mods];
...
const { sendGiveRingCommand, sendGiveCardCommand, sendGiveSkinCommand } = require('./give.js');
...
const { sendRedeemCommand, sendCustomFishCommand } = require('./servers.js');
...
module.exports.handleCommandInteraction = async function(interaction) {
    ...
    switch (interaction.commandName) {
        ...
        case 'customfish':
            sendCustomFishCommand(interaction, user);
            break;
