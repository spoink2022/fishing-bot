...
const { sendFishCommand } = require('./fish');
const { sendEquipmentCommand } = require('./profile');
const { sendQuestCommand, sendQuestClaimCommand, sendQuestResetCommand } = require('./quest');
const { sendStatsCommand, sendServerStatsCommand } = require('./stats');
...
module.exports.handleCommandInteraction = async function(interaction) {
    ...
    switch (interaction.commandName) {
        ...
        case 'questreset':
            ...
            break;
        case 'stats':
            sendStatsCommand(interaction, user);
            break;
        case 'serverstats':
