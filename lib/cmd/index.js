...
const { sendShopCommand, sendBaitShopCommand, sendServerShopCommand } = require('./shop.js');
...
module.exports.handleCommandInteraction = async function(interaction) {
    ...
    /*return interaction.reply('Slash Commands have been temporarily disabled! Please use the \`.\` prefix!').catch(() => {
...
\n(If this is something you see in every channel, try re-inviting Big Tuna).`).catch(() => {
            console.log('interaction (failed to reply)');
        });
    }
    ...
    switch (interaction.commandName) {
        ...
        case 'rankings':
            sendRankingsCommand(interaction, user);
            break;
