...
const { sendAquariumCommand, sendCollectCommand } = require('./aquarium.js');
const { sendFishCommand } = require('./fish.js');
const { sendEquipmentCommand } = require('./profile.js');
const { sendQuestCommand, sendQuestClaimCommand, sendQuestResetCommand } = require('./quest.js');
const { sendStatsCommand, sendServerStatsCommand } = require('./stats.js');
