...
module.exports.sendInfoCommand = async function(interaction, user) {
    ...
    let option = interaction.options.getString('thing');
    ...
    if (arg.endsWith('ring')) {
        ...
        return interaction.reply('NOT REAL ITEM');
    }
...
:scales: Weight: ${FishData.sizeMin}kg - ${FishData.sizeMax}kg+
:trophy: Personal Best: ${highest === -1 ? 'None' : logic.text.kgToWeight(calculateFishWeight(highest, FishData))}`,
