...
:two: Check out a new equipment type - Gloves! :gloves:\n\
:three: Learn about rings with `.help rings` and collect cards! :ring:\n\n\
**Once you have a ring, you can collect cards**\n\
...
\n\nA complete commands guide for clans can be found at our [Official Commands Page](https://bigtuna.xyz/commands/clans)'
        ...
        var options = {
            title: 'Help Rings - Everything About Rings',
            color: api.visuals.getColor('cmd', 'info'),
            description: '**Rings impact the quantity and quality of card drops**\
\n\n**Rings are bought in the shop in the form of packs** :shopping_cart:\
\nRegular packs give a regular type ring\
\nPremium packs have a chance to give a premium ring and have better stats\
...
\n`.help rings` - Everything About Rings'
        }
    } else {
        return;
    }
