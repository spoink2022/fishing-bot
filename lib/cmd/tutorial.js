...
\n**Step 1 - Go Fish!**
Type \`/fish\` or \`@Big Tuna f\` to cast your line.`
    };
...
\n**Step 2 - Check Stats**
Type \`/stats player\` or \`@Big Tuna s\` to check your stats.`
    }
...
Type \`/aquarium\` or \`@Big Tuna a\` to check your aquarium.`
    };
...
Type \`/equipment\` or \`@Big Tuna e\` to check your equipment.`
    };
...
\n**Helpful Commands:**
\`/shop\` or \`@Big Tuna shop\`
\`/help\` or \`@Big Tuna help\`
\`/cooldowns\` or \`@Big Tuna cd\``
    };
...
:small_blue_diamond: Fish in a new location with \`/setlocation 2\` or \`@Big Tuna sl 2\`
...
:small_blue_diamond: Buy bait with \`/baitshop\` or \`@Big Tuna bs\`
:small_blue_diamond: Educate yourself with \`/help bait\` or \`@Big Tuna help bait\`
:small_blue_diamond: Reset your cooldown with \`/vote\` or \`@Big Tuna vote\`
