...
module.exports.sendServerStatsCommand = async function(interaction) {
    ...
    let embed = {
        ...
        description: `${serverStats.premium_tier > 0 ? `:sparkles: Premium Tier ${serverStats.premium_tier} ${serverStats.premium_tier == 10 ? ' :sparkles:' : ''}\n\n` : ''}\
